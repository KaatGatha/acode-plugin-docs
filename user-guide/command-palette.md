...
On mobile devices where a physical keyboard might not be present, Acode provides **QuickTools**—a toolbar above the keyboard that contains essential keys like <kbd>Ctrl</kbd>.

![QuickTools](/quicktools.png)

You can use the <kbd>Ctrl</kbd> key from QuickTools in combination with the on-screen keyboard to trigger the shortcut.
